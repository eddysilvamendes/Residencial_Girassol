...
$expected = ['name', 'email', 'phone', 'info'];
$required = ['name', 'email', 'phone', 'info'];
...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'malalena.barreto@primeconsulting.org' =>
            ['#subject#' => 'Contacto Residencial Girassol',
                '#greeting#' => "Thanks, your contact was received!"],
        $email =>
            ['#subject#' => 'Contacto Residencial Girassol',
                '#greeting#' => "Thanks, your contact was received!"]
   ];
...
center">COntacto Residencial Girassol</h1>
</td>
</tr>
<tr>
...
// IMPORTANT: log an error before redirecting
        ...
        header("Location: index.html#contact"); /*error.php?f=$f */
        exit;
    } catch (Exception $e) {
        echo $e->getMessage();
    }
