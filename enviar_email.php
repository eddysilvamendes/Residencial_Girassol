...
$required = ['nome', 'num_quarto', 'nacionalidade', 'email','conhecimento','motivo','reserva','recepcao','simpatia','check_in','check_out','seguranca','limpeza','peq_almoco','empreend','internet','access_emp','access_ilha','estadia','comentarios'];
...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'malalena.barreto@primeconsulting.org' =>
            ['#subject#' => 'Formulario de Avaliacao da Residencial Girassol',
...
<title>Residencial Girassol</title>
</head>
